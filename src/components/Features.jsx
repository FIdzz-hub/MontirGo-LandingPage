        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div data-aos="fade-right" data-aos-duration="700">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4" data-aos="fade-up" data-aos-duration="600" data-aos-delay="100">
              ...
              <div className="flex gap-4" data-aos="fade-up" data-aos-duration="600" data-aos-delay="200">
                <div className="w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center shrink-0 text-[#4D77FF] font-bold">✓</div>
                <div>
          ...
          <div
            className="bg-[#4D77FF] text-white p-8 md:p-12 rounded-3xl shadow-xl shadow-blue-100 space-y-4"
            data-aos="fade-left"
